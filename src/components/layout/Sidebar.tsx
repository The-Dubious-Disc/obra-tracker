...
import { ObraTrackerLogo } from '@/components/ui/logo';
...
export function Sidebar({ open = false, onClose }: SidebarProps) {
  ...
  const content = (
    <div className="w-64 border-r bg-card h-full p-4 flex flex-col shadow-lg md:shadow-none industrial-card">
      <div className="mb-6 px-2 flex items-center justify-between">
        <div className="flex items-center gap-3"><ObraTrackerLogo className="h-6 w-auto" /><h1 className="text-xl font-bold tracking-tight">ObraTracker</h1></div>
        <Button variant="ghost" size="icon" className="md:hidden btn-industrial-outline" onClick={onClose}>
          <X className="h-4 w-4" />
        </Button>
      </div>
      ...
      <nav className="space-y-2 flex-1">
        <Button className="btn-industrial-outline w-full justify-start gap-2 h-auto py-2 px-3" asChild>
        ...
        <Button className="btn-industrial-primary w-full justify-start gap-2 h-auto py-2 px-3" asChild>
